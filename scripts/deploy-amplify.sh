...
# Huur-US AWS Amplify Deployment Script
...
update_amplify_app() {
    ...
    aws amplify update-app \
        ...
        --region ${AWS_REGION} \
        --description "Huur-US Toll Management Platform - Build ${BUILD_NUMBER}"
...
# Huur-US Amplify Deployment Summary
...
main() {
    log_info "Starting Huur-US AWS Amplify deployment..."
