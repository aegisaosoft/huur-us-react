@echo off
REM Huur-US AWS Amplify Deployment Script for Windows
...
echo [INFO] Starting Huur-US AWS Amplify deployment...
...
aws amplify update-app --app-id %AMPLIFY_APP_ID% --region %AWS_REGION% --description "Huur-US Toll Management Platform - Build %BUILD_NUMBER%"
if errorlevel 1 (
...
(
echo # Huur-US Amplify Deployment Summary
echo.
