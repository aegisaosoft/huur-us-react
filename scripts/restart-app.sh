...
# Huur-US Application Restart Script
# This script restarts the Huur-US application with proper service management

set -e

# Configuration
SERVICE_NAME="${SERVICE_NAME:-huur-us}"
APP_PORT="${APP_PORT:-5000}"
DEPLOY_DIR="${DEPLOY_DIR:-/var/www/huur-us}"
...
stop_application() {
    log_info "🛑 Stopping Huur-US application..."
...
start_application() {
    log_info "🔄 Starting Huur-US application..."
...
restart_application() {
    log_info "Starting Huur-US application restart process..."
    ...
    log_success "🎉 Application restart completed successfully!"
}
...
case "${1:-restart}" in
    ...
    "help"|"-h"|"--help")
        ...
        echo "  SERVICE_NAME  - Service name (default: huur-us)"
        echo "  APP_PORT      - Application port (default: 5000)"
        echo "  DEPLOY_DIR    - Deployment directory (default: /var/www/huur-us)"
