...
const Company: React.FC = () => {
  ...
  useQuery({
    ...
    queryFn: async () => {
      ...
      return { 
        data: {
          name: 'Huur-US',
          description: 'Learn more about Huur-US and our mission to simplify toll management.',
  ...
  return (
    <>
      ...
      <div id="fixed-side-image" className="huur-fixed-image">
        ...
        <div className="container narrow">
          <article>
            <div className="content-div">
              <h1>Huur Toll – Built for Car Rental Companies</h1>
              ...
              <p>Huur Toll was built to eliminate all of that.</p>

              <h2>What is Huur Toll?</h2>
              <p>Huur Toll is a complete toll management system designed for car rental companies. We handle:</p>
              <ul>
              ...
              <h2>Why Rental Companies Love Huur Toll</h2>
              <ul>
              ...
              <ol>
                <li>Add your vehicle to Huur Toll</li>
              ...
              <p className="final-statement">That's Huur Toll.</p>
            </div>
          </article>
        </div>
      </section>
