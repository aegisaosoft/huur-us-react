...
const EzPass: React.FC = () => {
  ...
  const { data: ezPassData, isLoading, error, refetch } = useQuery({
    ...
    queryFn: () => huurApi.getEzPass(dateFrom, dateTo, 1),
    enabled: hasSearched,
    retry: 1
  });
      ...
      <div className="container">
        ...
        {isLoading ? (
          ...
          <div className="total-amount-display">
            Total Amount: ${ezPassData.data.reduce((sum: number, row: EzPassRecord) => sum + (parseFloat(row.amount?.toString() || '0')), 0).toFixed(2)}
