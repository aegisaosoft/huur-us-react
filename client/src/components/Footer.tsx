        ...
        <div className="footer-bottom">
          <div className="footer-leftbar">
            ...
            <div className="footer-social footer-bottom-social">
              ...
              <a href="https://x.com/Huur_us" target="_blank" rel="noopener noreferrer" className="social-icon-link">
              ...
              <a href="https://www.instagram.com/huur_us/" target="_blank" rel="noopener noreferrer" className="social-icon-link">
          ...
          <div className="footer-center">
            <div className="footer-apps">
              <a href="https://play.google.com/store/apps/details?id=com.iroc.huur.app" target="_blank" rel="noopener noreferrer" className="app-link google-play">
                <i className="fab fa-google-play"></i>
                <span>Google Play</span>
              </a>
              <a href="https://apps.apple.com/us/app/huur/id1612416360" target="_blank" rel="noopener noreferrer" className="app-link app-store">
                <i className="fab fa-apple"></i>
                <span>App Store</span>
              </a>
              <a href="https://agsmhuurproduction.blob.core.windows.net/huur-owner-mvp-app/HuurOwner-win-Setup.exe" target="_blank" rel="noopener noreferrer" className="app-link desktop-app">
