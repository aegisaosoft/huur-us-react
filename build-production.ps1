# Huur-US Production Build Script for Windows PowerShell
...
Write-ColorOutput "Blue" "=== Huur-US Production Build Script ==="
...
try {
    ...
    Write-ColorOutput "Green" "✓ npm is installed: $npmVersion"
} catch {
...
$zipFile = "huur-us-deployment.zip"
...
Write-Host "2. Or use Azure CLI: az webapp deploy --name huur-web-us-2025 --resource-group huur_web --src-path $zipFile --type zip"
