# Huur-US Development Setup Script for PowerShell
...
Write-ColorOutput "Blue" "=== Huur-US Development Setup ==="
Write-Host ""
...
if (-not (Test-Path ".env")) {
    if (Test-Path "env.example") {
        ...
        Write-ColorOutput "Green" "✓ Environment file created from template"
...
"@ | Out-File -FilePath "client\.env.local" -Encoding utf8
    Write-ColorOutput "Green" "✓ Client environment file created"
} else {
    Write-ColorOutput "Green" "✓ Client environment file already exists"
}
