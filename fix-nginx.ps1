...
$command1 = "/share/ZFS530_DATA/.qpkg/container-station/usr/bin/docker stop huur-us-nginx && /share/ZFS530_DATA/.qpkg/container-station/usr/bin/docker rm huur-us-nginx"
...
$command2 = "/share/ZFS530_DATA/.qpkg/container-station/usr/bin/docker run -d --name huur-us-nginx -p 9443:80 nginx:alpine"
...
$command3 = "/share/ZFS530_DATA/.qpkg/container-station/usr/bin/docker exec huur-us-nginx sh -c 'echo \"$config\" > /etc/nginx/conf.d/default.conf'"
...
$command4 = "/share/ZFS530_DATA/.qpkg/container-station/usr/bin/docker restart huur-us-nginx"
